...
void render(uint32_t VAO, const Shader& shader_light, const Shader& shader_cube) {
	...
	shader_cube.set("ambientStrength", 0.3f);	//de 0.1 a 0.3

	shader_cube.set("lightPos", lightPos);

	shader_cube.set("viewPos", camera.getPosition());
	shader_cube.set("shineness", 256);			//de 128 a 256
	shader_cube.set("specularStrength", 0.3f);	//de 0.6 a 0.3
	*/
	...
	shader_cube.set("normalMat", normalMat);
	shader_cube.set("objectColor", 1.0f, 0.5f, 0.3f);
	shader_cube.set("lightColor", 0.75f, 0.75f, 0.75f);	//de 1.0 a 0.75
	shader_cube.set("ambientStrength", 0.4f);	//de 0.1 a 0.4

	shader_cube.set("lightPos", lightPos);

	shader_cube.set("viewPos", camera.getPosition());
	shader_cube.set("shineness", 512);			//de 128 a 512
	shader_cube.set("specularStrength", 0.8f);	//de 0.6 a 0.8
	*/
	...
	shader_cube.set("normalMat", normalMat);
	shader_cube.set("objectColor", 1.0f, 0.5f, 0.3f);
	shader_cube.set("lightColor", 0.7f, 0.7f, 0.7f);	//de 1.0 a 0.7
	shader_cube.set("ambientStrength", 0.05f);	//de 0.1 a 0.05

	shader_cube.set("lightPos", lightPos);

	shader_cube.set("viewPos", camera.getPosition());
	shader_cube.set("shineness", 64);			//de 128 a 64
	shader_cube.set("specularStrength", 0.2f);	//de 0.6 a 0.2
...
int main(int argc, char* argv[]) {
	...
	Shader shader_light("../tests/EJ06_02/light.vs", "../tests/EJ06_02/light.fs");
	Shader shader_cube("../tests/EJ06_02/cube.vs", "../tests/EJ06_02/cube.fs");
