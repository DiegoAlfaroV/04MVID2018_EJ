...
int main(int argc, char* argv[]) {
	...
	Shader lightingShader("../tests/EJ10_03/cube.vs", "../tests/EJ10_03/cube.fs");
	Shader colorShader("../tests/EJ10_03/blend.vs", "../tests/EJ10_03/blend.fs");
	...
	uint32_t text1 = createTexture("../tests/EJ10_03/albedo.png");
	uint32_t text2 = createTexture("../tests/EJ10_03/specular.png");
