...
glm::vec3 lightPos(0.5f, 1.0f, -2.5f);
...
void render(uint32_t VAO, const Shader& shader_light, const Shader& shader_phong, const Shader& shader_gouraud) {
	...
	shader_light.set("objectColor", 1.0f, 0.5f, 0.3f);
	shader_light.set("lightColor", 1.0f, 1.0f, 1.0f);
	shader_light.set("lightPos", lightPos);

	glm::mat3 normalMat = glm::inverse(glm::transpose(glm::mat3(model)));
	shader_light.set("normalMat", normalMat);
	...
	shader_phong.set("objectColor", 1.0f, 0.5f, 0.3f);
	shader_phong.set("lightColor", 1.0f, 1.0f, 1.0f);
	shader_phong.set("ambientStrength", 0.1f);

	shader_phong.set("lightPos", lightPos);

	shader_phong.set("viewPos", camera.getPosition());
	shader_phong.set("shineness", 128);
	shader_phong.set("specularStrength", 0.6f);
	...
	shader_gouraud.set("objectColor", 1.0f, 0.5f, 0.3f);
	shader_gouraud.set("lightColor", 1.0f, 1.0f, 1.0f);
	shader_gouraud.set("ambientStrength", 0.1f);

	shader_gouraud.set("lightPos", lightPos);

	shader_gouraud.set("viewPos", camera.getPosition());
	shader_gouraud.set("shineness", 128);
...
int main(int argc, char* argv[]) {
	...
	Shader shader_light("../tests/EJ06_06/light.vs", "../tests/EJ06_06/light.fs");
	Shader shader_phong("../tests/EJ06_06/phong.vs", "../tests/EJ06_06/phong.fs");
	Shader shader_gouraud("../tests/EJ06_06/gouraud.vs", "../tests/EJ06_06/gouraud.fs");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		render(VAO, shader_light, shader_phong, shader_gouraud);
