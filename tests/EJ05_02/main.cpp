...
int main(int argc, char* argv[]) {
	...
	Shader shader("../tests/EJ05_02/vertex.vs", "../tests/EJ05_02/fragment.fs");
	...
	uint32_t tex1 = createTexture("../tests/EJ05_02/EJ05_cube_uv.jpg");
