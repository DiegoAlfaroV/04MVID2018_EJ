...
void render(const Shader& lightingShader, const Shader& colorShader, const uint32_t cubeVAO, const uint32_t quadVAO, const uint32_t tex1, const uint32_t tex2) {
	...
	colorShader.set("myColor", 1.0f, 0.0f, 0.0f, 0.8f);
	...
	model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
	colorShader.set("model", model);
	colorShader.set("myColor", 0.0f, 1.0f, 0.0f, 0.4f);
	...
	model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
	colorShader.set("model", model);
	colorShader.set("myColor", 0.0f, 0.0f, 1.0f, 0.6f);
...
int main(int argc, char* argv[]) {
	...
	Shader lightingShader("../tests/EJ10_02/cube.vs", "../tests/EJ10_02/cube.fs");
	Shader colorShader("../tests/EJ10_02/blend.vs", "../tests/EJ10_02/blend.fs");
	...
	uint32_t text1 = createTexture("../tests/EJ10_02/albedo.png");
	uint32_t text2 = createTexture("../tests/EJ10_02/specular.png");
