...
int main(int argc, char* argv[]) {
	...
	Shader lightingShader("../tests/EJ12_02/cube.vs", "../tests/EJ12_02/cube.fs");
	Shader fboShader("../tests/EJ12_02/fbo.vs", "../tests/EJ12_02/fbo.fs");
	...
	uint32_t text1 = createTexture("../tests/EJ12_02/albedo.png");
	uint32_t text2 = createTexture("../tests/EJ12_02/specular.png");
