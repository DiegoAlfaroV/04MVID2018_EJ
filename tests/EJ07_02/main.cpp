...
void render(uint32_t VAO, const Shader& shader_light, const Shader& shader_cube) {
	...
	shader_cube.set("light.ambient", 0.4f, 0.3f, 0.2f);		//de 0.2f, 0.15f, 0.1f a 0.4f, 0.3f, 0.2f
	shader_cube.set("light.diffuse", 0.25f, 0.25f, 0.25f);	//de 0.5f, 0.5f, 0.5f a 0.25f, 0.25f, 0.25f
	shader_cube.set("light.specular", 1.0f, 0.6f, 0.8f);	//de 1.0f, 1.0f, 1.0f a 1.0f, 0.6f, 0.8f

	shader_cube.set("material.ambient", 0.2125f, 0.1275f, 0.054f);
	...
	shader_cube.set("material.ambient", 0.0215f, 0.1745f, 0.0215f);
	shader_cube.set("material.diffuse", 0.07568f, 0.61424f, 0.07568f);
	shader_cube.set("material.specular", 0.633f, 0.727811f, 0.633f);
	shader_cube.set("material.shininess", 76.8f);
	...
	shader_cube.set("material.ambient", 0.25f, 0.25f, 0.25f);
	shader_cube.set("material.diffuse", 0.4f, 0.4f, 0.4f);
	shader_cube.set("material.specular", 0.774597f, 0.774597f, 0.774597f);
	shader_cube.set("material.shininess", 76.8f);
	...
	shader_cube.set("material.ambient", 0.0f, 0.0f, 0.0f);
	shader_cube.set("material.diffuse", 0.1f, 0.35f, 0.1f);
	shader_cube.set("material.specular", 0.45f, 0.55f, 0.45f);
...
int main(int argc, char* argv[]) {
	...
	Shader shader_light("../tests/EJ07_02/light.vs", "../tests/EJ07_02/light.fs");
	Shader shader_cube("../tests/EJ07_02/cube.vs", "../tests/EJ07_02/cube.fs");
