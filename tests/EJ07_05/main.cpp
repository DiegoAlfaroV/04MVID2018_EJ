...
int main(int argc, char* argv[]) {
	...
	Shader shader_light("../tests/EJ07_05/light.vs", "../tests/EJ07_05/light.fs");
	Shader shader_cube("../tests/EJ07_05/cube.vs", "../tests/EJ07_05/cube.fs");

	uint32_t VBO, EBO;
	uint32_t VAO = createVertexData(&VBO, &EBO);
	uint32_t tex_dif = createTexture("../tests/EJ07_05/albedo.png");
	uint32_t tex_spec = createTexture("../tests/EJ07_05/new_specular.png");
