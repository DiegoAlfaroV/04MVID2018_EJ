...
void render(const Shader& lightingShader, const Shader& colorShader, const uint32_t cubeVAO, const uint32_t quadVAO, const uint32_t tex1, const uint32_t tex2) {
	...
	model = glm::mat4(1.0f);
	model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.2f, -4.0f));
	...
	colorShader.use();
	colorShader.set("proj", proj);
	colorShader.set("view", view);

	model = glm::mat4(1.0f);
	model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.2f, -3.0f));
	model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
	colorShader.set("model", model);
	colorShader.set("myColor", 1.0f, 0.0f, 0.0f, 0.6f);
	...
	model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
	colorShader.set("model", model);
	colorShader.set("myColor", 0.0f, 1.0f, 0.0f, 0.2f);
	...
	model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
	colorShader.set("model", model);
	colorShader.set("myColor", 0.0f, 0.0f, 1.0f, 0.4f);
...
int main(int argc, char* argv[]) {
	...
	Shader lightingShader("../tests/EJ10_04/cube.vs", "../tests/EJ10_04/cube.fs");
	Shader colorShader("../tests/EJ10_04/blend.vs", "../tests/EJ10_04/blend.fs");
	...
	uint32_t text1 = createTexture("../tests/EJ10_04/albedo.png");
	uint32_t text2 = createTexture("../tests/EJ10_04/specular.png");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		render(lightingShader, colorShader, cubeVAO, quadVAO, text1, text2);
