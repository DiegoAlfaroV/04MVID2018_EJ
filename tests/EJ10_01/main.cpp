...
void render(const Shader& lightingShader, const Shader& blendShader, const uint32_t cubeVAO,  const uint32_t quadVAO, const uint32_t tex1, const uint32_t tex2, const uint32_t tex3, const uint32_t textCrate) {
	...
	glActiveTexture(GL_TEXTURE0);
	glBindTexture(GL_TEXTURE_2D, textCrate);
	...
	model = glm::mat4(1.0f);
	model = glm::translate(glm::mat4(1.0f), glm::vec3(-1.0f, 0.2f, 0.0f));
	model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.4f));
	lightingShader.set("model", model);
	...
	model_tree = glm::translate(model_tree, glm::vec3(1.0f, 0.1f, 0.4f));
	...
	model_tree = glm::mat4(1.0f);
	model_tree = glm::translate(model_tree, glm::vec3(0.0f, 0.1f, 1.4f));
	model_tree = glm::scale(model_tree, glm::vec3(0.3f, 0.3f, 0.3f));
	model_tree = glm::rotate(model_tree, glm::pi<float>() / 2.0f, glm::vec3(1.0f, 0.0f, 0.0f));
	blendShader.set("model", model_tree);
	...
	model_tree = glm::mat4(1.0f);
	model_tree = glm::translate(model_tree, glm::vec3(1.0f, 0.1f, 1.4f));
	model_tree = glm::scale(model_tree, glm::vec3(0.3f, 0.3f, 0.3f));
	model_tree = glm::rotate(model_tree, glm::pi<float>() / 2.0f, glm::vec3(1.0f, 0.0f, 0.0f));
	blendShader.set("model", model_tree);
...
int main(int argc, char* argv[]) {
	...
	uint32_t text1 = createTexture("../tests/EJ10_01/albedo.png");
	uint32_t text2 = createTexture("../tests/EJ10_01/specular.png");
	uint32_t text3 = createTextureAlpha("../tests/EJ10_01/EJ10_grass.png");

	uint32_t textCrate = createTexture("../tests/EJ10_01/crate_texture.jpg");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		render(lightingShader, blendShader, cubeVAO, quadVAO, text1, text2, text3, textCrate);
